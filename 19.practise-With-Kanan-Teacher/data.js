...
//  countries_data.sort((a,b)=>b.area-a.area)
//  const sortedACountries=countries_data.slice(0,11)
//  console.log(sortedACountries);
//3
//  countries_data.sort((a,b)=>b.population-a.population)
//  const sortedByPopulation=countries_data.slice(0,11)
//  console.log(sortedByPopulation)
 //4
//ingilis dilli ölkeleri
//  const enLanguage=countries_data.filter((element)=>element.languages.includes('English'))
//  console.log(enLanguage);

 //region asia ve europe olanlar
 const byRegion=countries_data.filter(element=>element.region==='Asia'||element.region==='Europe')
 console.log(byRegion);

 //birdən çox əsas dili olan ölkələr
 const onlyEnglish=countries_data.filter((item)=>item.languages.length>1)
 console.log(onlyEnglish);

 //bütün ölkə adlari ve qarsisinda paytaxtı
 const countriesCapitals=[]
 countries_data.forEach(element=>element.name )